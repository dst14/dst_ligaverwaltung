...
/**
 * Test case for class Tx_Dst_ligaverwaltung_Controller_AdministratorController.
 *
 * @version $Id$
 ...
 */
class AdministratorControllerTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	/**
	 * @var 
	 */
	protected $fixture;
